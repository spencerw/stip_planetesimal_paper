...
Jacobi energy and permits a close encounter \citep{nakazawa88}. This value of $\tilde{b}$ is typically used to calculate the final isolation mass of a protoplanet, as oligarchic growth tends to ensure that embryos stay on near-circular orbits as they grow.}
...
clearly visible. \textbf{The feeding zone size $\tilde{b} = 2 \sqrt{3}$ permitted by bodies on circular, non-inclined orbits \citep{nazakawa88} is shown by the
