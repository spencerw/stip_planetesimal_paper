...
\begin{figure}
\begin{center}
    \includegraphics[width=0.5\textwidth]{figures/smooth_frac.png}
    \caption{Caption goes here.\label{fig:smooth_frac}}
\end{center}
\end{figure}

Show planetesimal distribution for each embryo, will look at this in more detail in paper 2

Show smooth vs chunky accretion plot for each embryo. Boundary visible at 60d
