...
that the asteroid belt, Kuiper belt and the Oort cloud are largely composed of the leftovers of this stage of planet formation (add reference).
...
form make statistical methods inappropriate because the highest mass bins contain only a few bodies. Due to computational expense, N-body simulations of
