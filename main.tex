...
% TRQ: perhaps "sub-linearly"?  I see dMdt ~ M^{2/3}
...
%TRQ large alpha (former) is cooler!?!
...
%TRQ Moving figure 2 up in the paper would help keep this discussion straight.
...
%TRQ: switched to delta for power law index
\begin{table}
...
%TRQ: add a qualitative description of the effect of this, e.g. what
%is the drift timescale caused by this drag.
...
% TRQ: ??? the masses of the initial planetesimals are the same in all
% simulations according to table 1.
...
%TRQ: perhaps use a logarithmic horizontal axis for better comparison
\begin{figure*}
\begin{center}
...
\begin{center}
    ...
    the embryo mass distribution and isolation mass. The shaded region
...
The simulations presented in this work were run on XSEDE/SDSC Comet and Expanse under allocation MCA94P018. SCW and TRQ were were supported by NSF award 62-2684. We acknowledge the people of the Dkhw’Duw’Absh, the Duwamish Tribe, the Muckleshoot Tribe, and other tribes on whose traditional lands we have performed this work.
