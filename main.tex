...
% Important note: need to use f=6 for the low alpha case, otherwise the simulation takes forever. Do these alpha values reflect the artifically enhanced collision cross section im using?
...
\noindent where $v_{k}$ is the local Keplerian velocity.
