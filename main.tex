...
\citep{chambers98}.
%TRQ "Suddenly" seems a drastic term to use here.
Suddenly, the oligarchics are no longer on isolated, stable orbits and
coalesce to form Earth-sized planets through a series of extremely
energetic, giant impacts \citep{kokubo02, raymond05, raymond06}.
%TRQ new paragraph here?
...
% planetesimals.  Also: mention that the scale height of the disk is
% assumed to be \Omega/(2v)
...
\end{equation}
%TRQ: changed this to match Ida & Makino 1993.
...
% Mention Rayleigh distribution: TRQ: yes!
...
%TRQ albeit for small alpha, only slightly cooler.
...
their absolute size, is what drives the system towards runaway
...
% TRQ: also mention the negative slope?
...
\end{equation}
%TRQ: should we use a different greek letter for the power law index?
...
%TRQ: the mass numbers in this table look wrong.
...
%TRQ there is no orange line in the figure.
